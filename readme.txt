...
Theme22 includes support for Infinite Scroll in Jetpack.

== Credits ==

* Based on Underscores http://underscores.me/, (C) 2012-2016 Automattic, Inc., [GPLv2 or later](https://www.gnu.org/licenses/gps-2.0.html)
...
* Address the issue with regard to navwalker https://wordpress.org/support/topic/version-3-3-3-breaks-wpms-language-switcher/
...
* theme22/woocommerce/cart/cart.php version 3.5.0 is out of date. The core version is 3.7.0
...
* Change the navbar-toggler data-bs-target attribute to #main-nav
...
= 2.3.3 - July 14, 2017 =
* Update the content of the container to load default content after theme install
...
= 2.2.8 - July 6, 2017 =
* Add an option in customizer to change the container content in homepage
...
* Change the style the background color of the container
...
* Remove the container in the header of internal pages except the homepage
...
= 1.2 - Nov 23, 2016 =
* Change the theme name to Theme22
